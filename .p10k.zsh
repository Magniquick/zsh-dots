# Generated by Powerlevel10k configuration wizard on 2024-01-08 at 11:04 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=#363a4f # catppucin-macchiato surface0
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=#cad3f5 # catppucin-macchiato text
  # Custom icon.
